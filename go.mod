...
replace github.com/docent-net/cluster-bare-autoscaler/core => ./core

replace github.com/docent-net/cluster-bare-autoscaler/metrics => ./metrics

replace github.com/docent-net/cluster-bare-autoscaler/utils/errors => ./utils/errors

replace github.com/docent-net/cluster-bare-autoscaler/utils/kubernetes => ./utils/kubernetes
